...
<head>
    ...
    <title>火鸡培根英式麦芬 | COFFEE休闲餐厅</title>
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <img src="../images/turkey-bacon-english-muffin.jpg" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <img src="../images/1ef51bade4b4e72f6f78c8c386a0be07.jpg" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <img src="../images/e89e99e5f2b8ed61593e97c2df8799b2.jpg" alt="" class="img-fluid">
                </div>
            </div>
            ...
            <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                        <img src="../images/turkey-bacon-english-muffin.jpg" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                        <img src="../images/1ef51bade4b4e72f6f78c8c386a0be07.jpg" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
                        <img src="../images/e89e99e5f2b8ed61593e97c2df8799b2.jpg" alt="" class="sm">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="order">
                ...
                <h1 class="title mb-3">火鸡培根英式麦芬</h1>
                <p class="text-justify tag">麦芬是一种快速蛋糕。而在英国，麦芬是英式麦芬English Muffins的意思，它是一种由酵母发酵的面包，通常来配正餐。通常搭配果酱或黄油，也常用来搭配肉类和鸡蛋。</p>
                <p class="text-justify tag">优质全麦面粉制作的英式麦芬，健康看得见。内夹香酥诱人的火鸡培根肉和质地细腻，口味柔和的白车达芝士，还有轻盈的纯蛋白饼。提供优质蛋白质的健康早餐选择。</p>
                <p class="text-justify tag">特点：香酥诱人，营养丰富</p>
                <p class="text-justify tag">咖啡搭配推荐：冰摇红莓黑加仑茶，抹茶拿铁（热/冷）</p>
            </div>
        </div>
    </div>
</section>
