...
<head>
    ...
    <title>绵云冷萃冰咖啡 | COFFEE休闲餐厅</title>
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <img src="../images/cold-foam-cold-brew.jpg" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <img src="../images/yun.png" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <img src="../images/yun2.png" alt="" class="img-fluid">
                </div>
            </div>
            ...
            <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                        <img src="../images/cold-foam-cold-brew.jpg" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                        <img src="../images/yun.png" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
                        <img src="../images/yun2.png" alt="" class="sm">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="order">
                ...
                <span class="caption">绵云冷萃冰咖啡</span>
                <h1 class="title mb-3">绵云冷萃冰咖啡</h1>
                <p class="text-justify tag">将冷萃咖啡注入新鲜搅打的脱脂奶冷奶沫中， 冷奶沫在冷萃咖啡中轻盈浮起，绵云般轻盈绵密口感伴随沁甘顺滑的冷萃咖啡， 最后以新鲜研磨的冷萃咖啡粉点缀，带来多重咖啡风味体验。</p>
                <p class="text-justify tag">尝一口，绵密的泡沫覆于唇边，如天鹅绒般顺滑感觉轻轻滑过，舌尖传来自然清新而悠长的回甘。</p>
                <p class="text-justify tag">采用特别的加工方式，赋予低温慢速萃取的冷萃咖啡，更绵密的泡沫,使它如天鹅绒般顺滑，口感更自然甘甜。</p>
                <p class="text-justify tag">特点：自然甘甜，香气迷人</p>
            </div>
        </div>
    </div>
</section>
