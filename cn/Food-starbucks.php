...
<head>
    ...
    <title>咖啡提拉米苏蛋糕 | COFFEE休闲餐厅</title>
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <img src="../images/starbucks-coffee-tiramisu.jpg" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <img src="../images/871f760ab913f697a8113bf6c1211961.jpg" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <img src="../images/e0cb9ed0f1fb901b2bc7a97240459042.jpg" alt="" class="img-fluid">
                </div>
            </div>
            ...
            <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                        <img src="../images/starbucks-coffee-tiramisu.jpg" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                        <img src="../images/871f760ab913f697a8113bf6c1211961.jpg" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
                        <img src="../images/e0cb9ed0f1fb901b2bc7a97240459042.jpg" alt="" class="sm">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="order">
                ...
                <h1 class="title mb-3">咖啡提拉米苏蛋糕</h1>
                <p class="text-justify tag">提拉米苏（Tiramisù），为一种有名的意大利式蛋糕，又可译成堤拉米苏。提拉米苏是由泡过咖啡或兰姆酒的手指饼干，加上一层马斯卡彭、蛋黄、干酪、糖的混合物，然后再在蛋糕表面洒上一层可可粉而成。</p>
                <p class="text-justify tag">精选意大利进口马斯卡波尼芝士和玛莎拉白葡萄酒，与咖啡相融合，将芝士、酒和咖啡的独特风味融合于一身，相得益彰。</p>
                <p class="text-justify tag">更有意大利进口手指饼干浸泡其中，带给你视觉和味觉的双重享受。甜与苦就像天使与魔鬼，和谐而又冲突地结合起来。</p>
                <p class="text-justify tag">特点：香醇浓郁，独一无二</p>
                <p class="text-justify tag">咖啡搭配推荐：卡布奇洛（热/冷），拿铁（热/冷）</p>
            </div>
        </div>
    </div>
</section>
