			  ...
			  <form class="login-form" action="login-submit.php" method="post">
				...
				<div class="row margin">
				  <div class="input-field col s12">
					...
					<input id="password" type="password" name="password" required="required" minlength="5" maxlength="10">
				...
				<div class="row">
				  <div class="input-field col s12 m2 l12">
					<p class="margin medium-small center-align">没有账号？<a href="register.php">现在注册</a></p>
				  </div>				
				</div>
			  </form>
			</div>
