...
<section class="container sorts">
    <div class="bg-white">
        <div class="nav nav-pills" id="pills-tab" role="tablist">
            ...
            <a class="nav-item nav-link text-nowrap active" id="list-list-list" data-toggle="tab" href="#list-list" role="tab" aria-controls="list-list" aria-selected="false">其他美食</a>
        </div>
    </div>
</section>
<!--分类 end-->
