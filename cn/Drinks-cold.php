...
<section class="container sorts">
    <div class="bg-white">
        <div class="nav nav-pills" id="pills-tab" role="tablist">
            ...
            <a class="nav-item nav-link text-nowrap active" id="list-set-list" data-toggle="tab" href="#list-set" role="tab" aria-controls="list-set" aria-selected="false">气致冷萃咖啡</a>
