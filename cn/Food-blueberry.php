...
<head>
    ...
    <title>蓝莓曲奇风轻乳酪蛋糕 | COFFEE休闲餐厅</title>
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <img src="../images/blueberry-and-cookie-style-cheesecake.jpg" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <img src="../images/a5754a75556d5b0f69ef80b88373e988.jpg" alt="" class="img-fluid">
                </div>
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <img src="../images/ee2b7bdc86a00819e9094c9ddb273818.jpg" alt="" class="img-fluid">
                </div>
            </div>
            ...
            <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                        <img src="../images/blueberry-and-cookie-style-cheesecake.jpg" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                        <img src="../images/a5754a75556d5b0f69ef80b88373e988.jpg" alt="" class="sm">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
                        <img src="../images/ee2b7bdc86a00819e9094c9ddb273818.jpg" alt="" class="sm">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-lg-6 col-sm-12 col-12">
            <div class="order">
                ...
                <h1 class="title mb-3">蓝莓曲奇风轻乳酪蛋糕</h1>
                <p class="text-justify tag">拼配三种不同品牌产地的奶油干酪使用独特的搅拌、烘烤工艺，打造出轻盈的芝士风味，和细腻丝滑口感，区别于纽约芝士蛋糕的醇厚。</p>
                <p class="text-justify tag">底部饼干底选择奥利奥风味曲奇制成，与众不同却不失经典的搭配，成为整只蛋糕的点睛之笔。</p>
                <p class="text-justify tag">配上大果粒蓝莓和树莓的清爽，这款轻盈爽滑的轻乳酪蛋糕更适合搭配有水果风味的饮品。</p>
                <p class="text-justify tag">特点：细腻丝滑，芝士风味</p>
                <p class="text-justify tag">咖啡搭配推荐：焦糖玛奇朵（热/冷），卡布奇洛（热/冷）</p>
            </div>
        </div>
    </div>
</section>
