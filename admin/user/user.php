    ...
    <div id="accordion">
        <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                <div class="card-body">
                    <a href="./user.php" class="nav-link text-danger"><span class="icon-group"></span>查看用户</a>
                </div>
                <div class="card-body">
                    <a href="./add.php" class="nav-link"><span class="icon-plus-sign"></span>添加用户</a>
                </div>
            </div>
        </div>
        <div class="card">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                while($row=mysqli_fetch_assoc($rst)){
                    ...
                    echo "<td><a onClick=\"return confirm('您确认删除用户？')\" href='delete.php?id={$row['id']}'>删除</a>	</td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
